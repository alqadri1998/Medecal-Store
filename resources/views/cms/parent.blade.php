...
<head>
    <base href="">
    <meta charset="utf-8"/>
    <title>Medical System | @yield('title')</title>
                ...
                <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1"
                    ...
                    <ul class="kt-menu__nav ">
                        <li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true">
                            <a href="{{route('cms.dashboard')}}" class="kt-menu__link "><span
                        ...
                        <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
                            data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
                                    ...
                                    class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg"
											...
											</svg></span><span class="kt-menu__link-text">Admins</span><i
                                ...
                                <ul class="kt-menu__subnav">
                                    ...
                                    <li class="kt-menu__item " aria-haspopup="true">
                                        <a href="{{route('admins.create')}}" class="kt-menu__link ">
                                            <i class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span
                                                class="kt-menu__link-text">Create</span><span
    ...
    -->
                    ...
                    <div class="kt-header__topbar-item kt-header__topbar-item--langs">
                        <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
									<span class="kt-header__topbar-icon">
										<img class="" src="{{asset('cms/assets/media/flags/226-united-states.svg')}}"
                                             alt=""/>
									</span>
                        </div>
                        <div
                            ...
                            <ul class="kt-nav kt-margin-t-10 kt-margin-b-10">
                                <li class="kt-nav__item kt-nav__item--active">
                                    <a href="#" class="kt-nav__link">
                                        <span class="kt-nav__link-icon"><img
                                                src="{{asset('cms/assets/media/flags/226-united-states.svg')}}" alt=""/></span>
                                ...
                                <li class="kt-nav__item">
                                    <a href="#" class="kt-nav__link">
                                        <span class="kt-nav__link-icon"><img
                                                src="{{asset('cms/assets/media/flags/128-spain.svg')}}" alt=""/></span>
                                ...
                                <li class="kt-nav__item">
                                    <a href="#" class="kt-nav__link">
                                        <span class="kt-nav__link-icon"><img
                                                src="{{asset('cms/assets/media/flags/162-germany.svg')}}"
                                                alt=""/></span>
                    ...
                    <div class="kt-header__topbar-item kt-header__topbar-item--user">
                        <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
                            <div class="kt-header__topbar-user">
                                ...
                                <img class="kt-hidden" alt="Pic" src="{{asset('cms/asset')}}s/media/users/300_25.jpg"/>
                            ...
                            <div class="kt-user-card kt-user-card--skin-dark kt-notification-item-padding-x"
                                ...
                                <div class="kt-user-card__avatar">
                                    <img class="kt-hidden" alt="Pic"
                                         src="{{asset('cms/assets/media/users/300_25.jpg')}}"/>
            ...
            <div class="kt-footer  kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop" id="kt_footer">
                <div class="kt-container  kt-container--fluid ">
                    <div class="kt-footer__copyright">
                        2020&nbsp;&copy;&nbsp;<a href="#" target="_blank" class="kt-link">Medical System</a>
                    </div>
    ...
    <div class="kt-demo-panel__body">
        <div class="kt-demo-panel__item kt-demo-panel__item--active">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{asset('cms/assets/media//demos/preview/demo1.jpg')}}" alt=""/>
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{asset('cms/assets/media//demos/preview/demo2.jpg')}}" alt=""/>
                <div class="kt-demo-panel__item-preview-overlay">
                    <a href="#"
                       class="btn btn-brand btn-elevate " target="_blank">Default</a>
                    <a href="#"
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{asset('cms/assets/media//demos/preview/demo3.jpg')}}" alt=""/>
                <div class="kt-demo-panel__item-preview-overlay">
                    <a href="#"
                       class="btn btn-brand btn-elevate " target="_blank">Default</a>
                    <a href="#"
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{asset('cms/assets/media//demos/preview/demo4.jpg')}}" alt=""/>
                <div class="kt-demo-panel__item-preview-overlay">
                    <a href="#"
                       class="btn btn-brand btn-elevate " target="_blank">Default</a>
                    <a href="#"
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{asset('cms/assets/media//demos/preview/demo5.jpg')}}" alt=""/>
                <div class="kt-demo-panel__item-preview-overlay">
                    <a href="#"
                       class="btn btn-brand btn-elevate " target="_blank">Default</a>
                    <a href="#"
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{asset('cms/assets/media//demos/preview/demo6.jpg')}}" alt=""/>
                <div class="kt-demo-panel__item-preview-overlay">
                    <a href="#"
                       class="btn btn-brand btn-elevate " target="_blank">Default</a>
                    <a href="#"
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{asset('cms/assets/media//demos/preview/demo7.jpg')}}" alt=""/>
                <div class="kt-demo-panel__item-preview-overlay">
                    <a href="#"
                       class="btn btn-brand btn-elevate " target="_blank">Default</a>
                    <a href="#"
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{asset('cms/assets/media//demos/preview/demo8.jpg')}}" alt=""/>
                <div class="kt-demo-panel__item-preview-overlay">
                    <a href="#"
                       class="btn btn-brand btn-elevate " target="_blank">Default</a>
                    <a href="#"
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{asset('cms/assets/media//demos/preview/demo9.jpg')}}" alt=""/>
                <div class="kt-demo-panel__item-preview-overlay">
                    <a href="#"
                       class="btn btn-brand btn-elevate " target="_blank">Default</a>
                    <a href="#"
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{asset('cms/assets/media//demos/preview/demo10.jpg')}}" alt=""/>
                <div class="kt-demo-panel__item-preview-overlay">
                    <a href="#"
                       class="btn btn-brand btn-elevate " target="_blank">Default</a>
                    <a href="#"
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{asset('cms/assets/media//demos/preview/demo11.jpg')}}" alt=""/>
                <div class="kt-demo-panel__item-preview-overlay">
                    <a href="#"
                       class="btn btn-brand btn-elevate " target="_blank">Default</a>
                    <a href="#"
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{asset('cms/assets/media//demos/preview/demo12.jpg')}}" alt=""/>
                <div class="kt-demo-panel__item-preview-overlay">
                    <a href="$"
                       class="btn btn-brand btn-elevate " target="_blank">Default</a>
                    <a href="#"
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{asset('cms/assets/media//demos/preview/demo13.jpg')}}" alt=""/>
                <div class="kt-demo-panel__item-preview-overlay">
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{asset('cms/assets/media//demos/preview/demo14.jpg')}}" alt=""/>
                <div class="kt-demo-panel__item-preview-overlay">
                    <a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
                </div>
            </div>
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{asset('cms/assets/media//demos/preview/demo15.jpg')}}" alt=""/>
                <div class="kt-demo-panel__item-preview-overlay">
                    <a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
                </div>
            </div>
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{asset('cms/assets/media//demos/preview/demo16.jpg')}}" alt=""/>
                <div class="kt-demo-panel__item-preview-overlay">
                    <a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
                </div>
            </div>
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{asset('cms/assets/media//demos/preview/demo17.jpg')}}" alt=""/>
                <div class="kt-demo-panel__item-preview-overlay">
                    <a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
                </div>
            </div>
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{asset('cms/assets/media//demos/preview/demo18.jpg')}}" alt=""/>
                <div class="kt-demo-panel__item-preview-overlay">
                    <a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
                </div>
            </div>
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{asset('cms/assets/media//demos/preview/demo19.jpg')}}" alt=""/>
                <div class="kt-demo-panel__item-preview-overlay">
                    <a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
                </div>
            </div>
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{asset('cms/assets/media//demos/preview/demo20.jpg')}}" alt=""/>
                <div class="kt-demo-panel__item-preview-overlay">
                    <a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
                </div>
            </div>
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{asset('cms/assets/media//demos/preview/demo21.jpg')}}" alt=""/>
                <div class="kt-demo-panel__item-preview-overlay">
                    <a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
                </div>
            </div>
                            ...
                            <div class="kt-chat__messages kt-chat__messages--solid">
                                <div class="kt-chat__message kt-chat__message--success">
                                    <div class="kt-chat__user">
												<span class="kt-media kt-media--circle kt-media--sm">
													<img src="{{asset('cms/assets/media/users/100_12.jpg')}}"
                                                         alt="image">
												</span>
                                ...
                                <div class="kt-chat__message kt-chat__message--right kt-chat__message--brand">
                                    <div class="kt-chat__user">
                                        ...
                                        <span class="kt-media kt-media--circle kt-media--sm">
													<img src="{{asset('cms/assets/media/users/300_21.jpg')}}"
                                                         alt="image">
												</span>
                                    </div>
                                    <div class="kt-chat__text">
